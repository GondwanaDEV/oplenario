...
| `console-operador` | ✅ **FEITO (26/06)** — status **"Aguardando 1º admin"** (handoff C03) + nota "provisionar é handoff, não controle" + nota de **suspensão que preserva LAI** (portal/transparência/e-SIC seguem no ar; acervo/trilha preservados) |
