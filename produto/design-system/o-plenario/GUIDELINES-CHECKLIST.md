...
|---|---|---|
| **Branco sobre `--telha`** (#C0693F) | **4.0** (texto não-grande falha) | use **`--telha-fundo`** (#A85334) = **5.44**. Já aconteceu 3×. |
...
| **Pílula/badge âmbar com texto** (sessão, calendário) | branco-sobre-âmbar ≈ 2–4; texto-escuro-sobre-`--amarelo-traco`(médio) ≈ 4.3 | âmbar é cor CLARA → fundo **`--amarelo`** (#CFA65C brilhante, invariante) + **texto escuro** (#2E2102) = ~8 nos dois temas. Nunca branco sobre âmbar. |
