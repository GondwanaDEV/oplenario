...
> **"Confirmo" do Daouda dado com o merge do PR #38 (26/09/2026)**; desenho consolidado no doc-mestre v1.46 (§22.11). **Base comum (0.1–0.5) entregue** — `apps/ia/`, ADR-0006, [PR #42](https://github.com/GondwanaDEV/oplenario/pull/42) (branch `claude/track-ia-base`). **Faixa A:** A.2 captação ([PR #43](https://github.com/GondwanaDEV/oplenario/pull/43)); A.3 transcrição + Caminho C + fronteira core↔IA, ADR-0008 ([PR #44](https://github.com/GondwanaDEV/oplenario/pull/44)); **A.6 ata-IA completa**: ata como artefato do core com retificação ([PR #45](https://github.com/GondwanaDEV/oplenario/pull/45)), rascunho pelo núcleo com citação conferida e revisão ([PR #46](https://github.com/GondwanaDEV/oplenario/pull/46)), revisão humana medida de volta na IA (A.6c). Tudo com o fornecedor fake até o `[GAP]` jurídico. A.1 (medir com áudio real) segue esperando o áudio de Baturité; faltam A.4/A.5, A.7 e A.8.
