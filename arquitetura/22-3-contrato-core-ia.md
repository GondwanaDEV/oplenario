...
**Nota v1.46 (§22.11.5) — o canal agente → core.** Além dos eventos de integração e da API síncrona desta seção, a IA que **age** sobre a plataforma (agente do satélite) chama o core pelo **servidor MCP**, que mora no core como adaptador de entrada (Inv. 5) e expõe o catálogo de ações (§22.11.2); o navegador fala com o core, nunca com o satélite, e recebe o agente em SSE. Estende a topologia do §22.3.1 sem mudar os contratos acima.
