...
(defrecord RepoCadastrosPg [datasource]
  ...
  (legislatura-vigente [this ente-id] (transacao this ente-id estrutura/legislatura-vigente))
  ...
  (vereador-por-identidade [this ente-id ident] (transacao this ente-id #(vereador/por-identidade % ident)))
  ...
  (mandatos-do-vereador [this ente-id ver-id] (transacao this ente-id #(vereador/mandatos-do-vereador % ver-id)))
